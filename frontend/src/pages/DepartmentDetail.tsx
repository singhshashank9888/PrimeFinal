...
const departmentBanners = {
    ...
    ophthalmology: "https://images.unsplash.com/photo-1582719201913-342b4cd501b1?auto=format&fit=crop&q=80&w=2000",
...
const DepartmentDetail = () => {
    ...
    if (!dept) return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground">
            ...
            <Link to="/departments" className="mt-4 text-primary font-bold hover:underline">Explore All Departments</Link>
        </div>
    );
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <div className="bg-card p-8 md:p-12 rounded-[var(--radius)] shadow-2xl border border-border">
                            ...
                            <h3 className="text-xl font-bold mb-6 text-card-foreground border-l-4 border-primary pl-4 uppercase tracking-wide">
                                Key Services
                            </h3>
                            <div className="grid md:grid-cols-2 gap-4 mb-12">
                                {dept.services.map((service, i) => (
                                    <div key={i} className="flex items-center gap-4 p-5 rounded-xl bg-secondary/20 border border-border hover:border-primary/40 transition-all group">
                                        <div className="bg-primary/10 p-2 rounded-lg text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-all">
                                            <Stethoscope size={18} />
                                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                {dept.highlights.map((h, i) => (
                                    <div key={i} className="text-center p-6 rounded-2xl bg-primary text-primary-foreground shadow-lg shadow-primary/10 transition-transform hover:-translate-y-1">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid sm:grid-cols-2 gap-6">
                                    {filteredDoctors.map((doc) => (
                                        <div key={doc.name} className="bg-card border border-border rounded-[var(--radius)] p-6 flex items-center gap-5 hover:shadow-xl transition-all border-l-4 border-l-primary">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-primary font-bold mb-1 uppercase tracking-tighter">{doc.specialty}</p>
                    ...
                    {/* SIDEBAR */}
                    <div className="space-y-6">
                        <div className="bg-primary p-10 rounded-[var(--radius)] text-primary-foreground shadow-2xl relative overflow-hidden group">
                            <Award className="text-primary-foreground/40 mb-6" size={48} />
                            ...
                            <Link to="/appointments" className="block text-center bg-background text-foreground font-bold py-4 rounded-xl hover:bg-secondary transition-all shadow-lg uppercase text-sm tracking-widest">
                                Book Appointment
                            </Link>
                        </div>
